    ...
    <div className="min-h-screen flex font-sans bg-white">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-[#5B58F6]">
        ...
        <div className="absolute top-0 left-0 w-full h-full opacity-10 pointer-events-none">
          <div className="absolute top-[15%] right-[-10%] w-[50%] h-[50%] rounded-full bg-white blur-[150px]"></div>
          <div className="absolute bottom-[10%] left-[-5%] w-[35%] h-[35%] rounded-full bg-white blur-[110px]"></div>
        </div>
        ...
        <div className="relative z-10 flex flex-col justify-between w-full px-16 py-16">
          ...
          <div className="flex-1 flex flex-col justify-center max-w-lg">
            <h2 className="text-5xl font-light text-white mb-8 leading-[1.1] tracking-tight font-serif">
              Join the next generation of <span className="italic font-normal">tech talent</span>.
            </h2>
            <p className="text-white/80 text-xl font-light leading-relaxed">
              Create an account to start your journey with industry-standard 
              curriculum, world-class mentors, and career-boosting projects.
            </p>
          </div>
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="space-y-6">
            <div className="space-y-3">
              <h2 className="text-4xl font-light text-slate-900 tracking-tight font-serif">Create Account</h2>
              <p className="text-slate-500 font-light text-lg tracking-tight">
                Start your journey towards technical excellence today.
              </p>
            </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    <User className="h-5 w-5 text-slate-400 group-focus-within:text-[#5B58F6] transition-colors" />
                  </div>
                  <input
                    id="name"
                    type="text"
            ...
            <button
              className="w-full h-14 bg-[#5B58F6] hover:bg-[#4a47e6] text-white text-lg font-medium rounded-2xl shadow-lg shadow-indigo-100 transition-all hover:-translate-y-0.5 active:scale-[0.98] mt-4"
            >
              Create Account
            </button>
            ...
            <div className="relative py-2">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-white px-4 text-slate-400 font-medium tracking-wider">Or sign up with</span>
              </div>
            </div>
            ...
            <p className="text-center text-slate-500 font-light pt-4 tracking-tight">
              Already have an account?{" "}
              <Link href="/login" className="font-semibold text-[#5B58F6] hover:text-[#4a47e6] transition-colors underline-offset-4 hover:underline">
                Sign In
              </Link>
            </p>
          </div>
